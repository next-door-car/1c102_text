...
#ifndef __LS1C103_TIM_H
#define __LS1C103_TIM_H
...
#define IS_TIM_1_PERIPH(PERIPH) (((*(uint32_t*)&(PERIPH)) == TIM1_BASE))

#define IS_TIM_12_PERIPH(PERIPH) (((*(uint32_t*)&(PERIPH)) == TIM1_BASE) || \
                                      ((*(uint32_t*)&(PERIPH)) == TIM2_BASE))
